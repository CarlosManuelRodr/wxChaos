...
JuliaConstantDialog::JuliaConstantDialog(bool* active, FractalPresenter* presenter, wxWindow* parent, const wxWindowID id,
                                         ...
                                         const long style) : wxDialog(parent, id, wxGetTranslation(title), pos, size, style)
{
    ...
    const auto realSizer = new wxStaticBoxSizer(new wxStaticBox(_dumbPanel, wxID_ANY, _("Real value")), wxVERTICAL);
    ...
    const auto imSizer = new wxStaticBoxSizer(new wxStaticBox(_dumbPanel, wxID_ANY, _("Imaginary value")), wxVERTICAL);
    ...
    _okButton = new wxButton(_dumbPanel, wxID_ANY, _("Ok"), wxDefaultPosition, wxDefaultSize, 0);
    okSizer->Add(_okButton, 0, wxALL, 5);
    buttonSizer->Add(okSizer, 1, wxEXPAND, 5);

    const auto applySizer = new wxBoxSizer(wxVERTICAL);
    
    _applyButton = new wxButton(_dumbPanel, wxID_ANY, _("Apply"), wxDefaultPosition, wxDefaultSize, 0);
