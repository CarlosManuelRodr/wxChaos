...
{
private:
    std::vector<std::string> labels;   ///< Vector that contains all the labels found.
    std::vector<std::string> args;     ///< Vector that contains all the arguments found.
    bool fileOpened;         ///< Status of the opened file.
    std::string filename;
public:
    ///@brief Constructor
    ///@param filename File to analyze.
    ConfigParser(std::string _filename);
    ...
    void ReplaceArg(std::string label, std::string replaceArg);
    ...
    bool IntArgToVar(int& myVar, std::string expr, int defaultValue);
    ...
    ///@param defaultValue If expr isn't found stores this default value.
    ///@return true if expr was found. False if not.
    bool UIntArgToVar(unsigned int& myVar, std::string expr, unsigned int defaultValue);
    ...
    ///@param defaultValue If expr isn't found stores this default value.
    ///@return true if expr was found. False if not.
    bool DblArgToVar(double& myVar, std::string expr, double defaultValue);
    ...
    ///@param defaultValue If expr isn't found stores this default value.
    ///@return true if expr was found. False if not.
    bool BoolArgToVar(bool& myVar, std::string expr, bool defaultValue);
    ...
    ///@param defaultValue If expr isn't found stores this default value.
    ///@return true if expr was found. False if not.
    bool StringArgToVar(std::string& myVar, std::string expr, std::string defaultValue);
